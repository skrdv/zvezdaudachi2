<div class="col-lg-16 col-md-16 col-sm-16 col-xs-16"  id="zvezda-header">
    ...
    <div class="row">
        <div class="col-lg-14 col-md-14 col-sm-13 col-xs-16" id="zvezda-header-left">
            <div id="zvezda-logo-1">
                ВСЕРОССИЙСКИЙ ТВОРЧЕСКИЙ КОНКУРС ДЛЯ ШКОЛЬНИКОВ
            </div>
        ...
        <nav>
                ...
                <div class="" id="school-menu-navigation">
    ...
    <div class="row">
        <div class="col-lg-16 col-md-16 col-sm-16 col-xs-16" id="zvezda-header-row">
            <div id="zvezda-logo-3" class="zvezda-logo-3">
                <a class="zvezda-logo-link" href="/"></a>


                <div id="zvezda-logo-3-social" style="visibility:<?php if (current_path() == 'node/83758') {echo 'hidden'; } ?>">
                    <ul class="list-unstyled social-btns">
                        <li><a title="vk.com" href="http://vk.com/zu014" class="vk"></a></li>
